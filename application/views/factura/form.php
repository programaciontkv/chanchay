                          ...
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if(form_error('nombre')!=''){ echo 'has-error';}?> ">
                                <input maxlength="75" type="text" class="form-control" name="nombre" id="nombre" value="<?php if(validation_errors()!=''){ echo set_value('nombre');}else{ echo $factura->fac_nombre;}?>" >
                          ...
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if(form_error('direccion_cliente')!=''){ echo 'has-error';}?> ">
                                <input maxlength="75" type="text" class="form-control" name="direccion_cliente" id="direccion_cliente" value="<?php if(validation_errors()!=''){ echo set_value('direccion_cliente');}else{ echo $factura->fac_direccion;}?>">
              ...
              if(m_pag==1 && $('#pag_forma1').val().length==0){
                ...
                $.ajax({
                  beforeSend: function () {
                    ...
                    success: function (dt) {
                      if (dt!='') {
                        console.log(dt.pro_descripcion);
